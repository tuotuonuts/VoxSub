...
当前源码候选版本：`0.9.0-beta`；GitHub 当前公开下载仍为 `0.7.2-beta`。实时 OCR 视觉与稳定性修复继续沿用同一候选版本，在用户验收前不会冒充已发布版本。本地最新候选安装包为 `277,285,664` 字节（264.44 MiB），SHA256 `03B51AEF74177A10CEC18A44F29D6B619385C30A144881C43E30D61DCC8656AE`。
