...
当前源码候选版本：`0.9.0-beta`；GitHub 当前公开下载仍为 `0.7.2-beta`。实时 OCR 视觉与稳定性修复继续沿用同一候选版本，在用户验收前不会冒充已发布版本。本地最新候选安装包为 `277,767,511` 字节（264.90 MiB），SHA256 `C17D091B90F85CDD639A30876039A82886195BADCBA8192069F914943DA92DAF`。
