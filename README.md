...
- 上一个已完成的本地候选包：`D:\OneDrive\app_dve\Release\VoxSub-Setup-0.7.0-beta.exe`，214,865,840 字节（204.91 MiB）；SHA256 `252DE9C8881D1E268DA6053158F01368539B56D7A86902DDAE30D0E089F46D20`。`0.7.1-beta` 正在构建，尚未创建 GitHub Release。
