...
Current source candidate: `0.9.0-beta`; the current public GitHub download remains `0.7.2-beta`. The live-OCR visual and stability fixes continue under the same candidate version and are not presented as released before user acceptance. The latest local candidate installer is 277,285,664 bytes (264.44 MiB), SHA256 `03B51AEF74177A10CEC18A44F29D6B619385C30A144881C43E30D61DCC8656AE`.
