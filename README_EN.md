...
- Local candidate: `D:\OneDrive\app_dve\Release\VoxSub-Setup-0.7.1-beta.exe`, 214,877,960 bytes (204.92 MiB); SHA256 `64B54C296C3CF5A53BB867889DA9CF479373BD79933E1377EB70C62BCEDC2C0B`. It carries the `CN=VoxSub Dev (self-signed)` development signature, which Windows may still treat as untrusted. Please validate it locally first; no GitHub Release has been created.
