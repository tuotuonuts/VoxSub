...
Current source candidate: `0.9.0-beta`; the current public GitHub download remains `0.7.2-beta`. The live-OCR visual and stability fixes continue under the same candidate version and are not presented as released before user acceptance. The latest local candidate installer is 277,767,511 bytes (264.90 MiB), SHA256 `C17D091B90F85CDD639A30876039A82886195BADCBA8192069F914943DA92DAF`.
