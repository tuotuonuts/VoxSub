...
Current source: `0.7.1-beta` (candidate, not released). Current public download: `0.5.0-beta`. The public installer passed its build, isolated startup check, and GitHub asset digest verification. Both remain development builds.
...
- Previous completed local candidate: `D:\OneDrive\app_dve\Release\VoxSub-Setup-0.7.0-beta.exe`, 214,865,840 bytes (204.91 MiB); SHA256 `252DE9C8881D1E268DA6053158F01368539B56D7A86902DDAE30D0E089F46D20`. The `0.7.1-beta` package is being built; no GitHub Release has been created.
