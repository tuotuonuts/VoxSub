...
- [x] v0.4.2-beta 候选安装包：214,762,511 字节（204.81 MiB），SHA256 `9B691BF2FE6B5F9F3AD7C0B53CB936547D38550CC894BDC8FAA43684770E99D6`；隔离配置启动 12 秒通过；当前用户证书库无可用 VoxSub 证书，安装包与主程序未签名；用户验证前不创建 GitHub Release
...
- [x] v0.5.0-beta 候选安装包：214,795,950 字节（204.85 MiB），SHA256 `38CF47DE43CB39B45BAF8241464A7C06B5AEF6AF28CE15FF76E7B32063047EA8`；隔离配置启动 12 秒通过；当前用户证书库无可用 VoxSub 证书，安装包与主程序未签名；用户验证前不创建 GitHub Release
...
3. 使用 v0.5.0-beta 对会议、网课和中英混合素材 A/B 验证智能上下文的断句、纠偏、语气词清理和最长等待；同时继续验证云端兼容服务和长时间运行稳定性
