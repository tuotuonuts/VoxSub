...
- [x] v0.4.2-beta 源码候选：完成配置 schema、全链路有界队列、TTS worker、原子文件提交、Pipeline/UI/下载/硬件/llama 启动职责拆分及自动架构守卫；全量 228 passed / 8 skipped
- [x] v0.4.2-beta 候选安装包：204.81 MiB，SHA256 `187C75E2B494C6BF4A00671571174D0E71398BD9EBAD45B43172CE5BB91976AC`；隔离配置启动 12 秒通过；当前用户证书库无可用 VoxSub 证书，安装包与主程序未签名；用户验证前不创建 GitHub Release
