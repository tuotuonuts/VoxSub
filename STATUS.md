...
- [x] v0.6.0-beta 候选：智能上下文新增单行双语动态草稿、Zipformer 140ms partial、partial 保守纠偏、最新 revision 临时翻译和终句优先策略；生成式/云 STT 保持片段级能力边界；旧模式不发送临时翻译请求；全量与构建门禁均为 248 passed / 8 skipped；安装包 214,803,769 字节，SHA256 `8E2463AB10D6357E404B9AE47109A6EF5D0353D2DCD3D80851580A569D9CD84D`；隔离启动通过；未签名、未发布 Release
...
3. 使用 v0.6.0-beta 候选包对会议、网课和中英混合素材 A/B 验证当前句逐步更新、前文纠偏、动态译文、断句和长时间运行稳定性；用户验证通过前不发布新 Release
