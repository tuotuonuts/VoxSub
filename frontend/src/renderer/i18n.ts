...
const EN: Dict = {
  ...
  "质量档": "Quality",
  "云端": "Cloud",
  "不支持当前语言": "Not for this language",
  "{pair}：当前档位支持 {langs}": "{pair}: this tier supports {langs}",
  "{pair}：所选「{from}」不支持该语言对，会话将自动使用「{to}」": "{pair}: the selected \"{from}\" does not support this language pair — the session will use \"{to}\" instead",
  "{pair}：当前没有档位支持该语言对，翻译会保留原文": "{pair}: no tier supports this language pair; the original text will be kept",
  "API 地址": "API endpoint",
  "API 密钥": "API key",
  "模型名": "Model name",
