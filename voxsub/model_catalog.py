...
CATALOG: tuple[ModelSpec, ...] = (
    ModelSpec(
        ...
        release="2026-08-20",
        description="随应用内置的中英多语言均衡模型，支持 DirectML GPU 加速，适合屏幕、网页、字幕和常规图片。",
    ...
    ModelSpec(
        ...
        vendor="PaddleOCR / RapidAI",
        release="2026-08-20",
        description="更轻的实时区域识别模型，支持 DirectML GPU 加速，适合低功耗电脑和频繁变化的屏幕内容。",
    ...
    ModelSpec(
        ...
        vendor="PaddleOCR / RapidAI",
        release="2026-08-20",
        description="更高精度的多语言档；实时使用建议启用 DirectML GPU，适合复杂排版、小字和导出译后图片。",
    ...
    ModelSpec(
        ...
        vendor="PaddleOCR / RapidAI",
        release="2025-05-20",
        description="面向中英文复杂文档、竖排与手写场景的质量档；支持 DirectML GPU，艺术字仍取决于字形清晰度。",
