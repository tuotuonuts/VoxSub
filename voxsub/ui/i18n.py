...
TRANSLATIONS: dict[str, str] = {
    ...
    "OCR 图片翻译": "OCR Image Translation",
    "截图、上传图片或选定屏幕范围实时翻译":
        "Translate a screenshot, uploaded image, or live screen region",
    "OCR 屏幕翻译": "OCR Screen Translation",
    "OCR 图片与屏幕翻译": "OCR Image & Screen Translation",
    "截图 OCR 或选定屏幕范围实时翻译":
        "Translate one screenshot or a continuously monitored screen region",
    "截图 OCR 翻译": "Screenshot OCR",
    "实时区域 OCR": "Live Region OCR",
    "一次截图适合图片与文档；实时区域只在画面变化时重新识别，并把译文原位覆盖。":
        "Use a screenshot for images and documents. Live Region recognizes only when the image changes and overlays translations in place.",
    "框选屏幕并翻译": "Select screen area and translate",
    "上传图片并翻译": "Upload image and translate",
    "查看原图": "View source image",
    "查看覆盖译文": "View translation overlay",
    "导出译后图片": "Export translated image",
    "选择要翻译的图片": "Choose an image to translate",
    "图片文件 (*.png *.jpg *.jpeg *.bmp *.webp *.tif *.tiff)":
        "Image files (*.png *.jpg *.jpeg *.bmp *.webp *.tif *.tiff)",
    "所有文件 (*)": "All files (*)",
    "上一张图片仍在处理中": "The previous image is still being processed",
    "无法读取这张图片，请换用 PNG、JPG 或 WebP":
        "This image could not be read. Try PNG, JPG, or WebP.",
    "正在识别并翻译上传图片…": "Recognizing and translating the uploaded image...",
    "图片缓存不可用": "Image cache unavailable",
    "截图缓存不可用": "Screenshot cache unavailable",
    "译后图片未缓存": "Translated image was not cached",
    "当前没有可导出的译后图片": "There is no translated image to export",
    "PNG 图片 (*.png)": "PNG image (*.png)",
    "JPEG 图片 (*.jpg *.jpeg)": "JPEG image (*.jpg *.jpeg)",
    "导出失败": "Export failed",
    "已导出译后图片": "Translated image exported",
    "等待框选": "Waiting for a selection",
    "截图预览": "Screenshot preview",
    "识别原文": "Recognized source",
    "复制原文": "Copy source",
    "译文": "Translation",
    "复制译文": "Copy translation",
    "框选后显示结果": "Results appear after selecting an area",
    "原位覆盖，不重复识别静止画面":
        "In-place overlay without repeatedly recognizing a static image",
    "选择一块游戏、视频、网页或应用区域。VoxSub 会保留文字坐标，用取自原图的背景色遮住原文，再在同一位置绘制译文。":
        "Select an area in a game, video, webpage, or app. VoxSub preserves text coordinates, covers the source using colors sampled from the image, and draws the translation in the same place.",
    "选择区域并开始": "Select area and start",
    "结束实时 OCR": "Stop live OCR",
    "未选择区域": "No area selected",
    "隐私：截图像素只在本机内存中送入 OCR；只有当你在设置中选择云翻译时，识别出的文字才会发送给对应翻译服务。":
        "Privacy: screenshot pixels are processed by OCR only in local memory. Recognized text is sent to a translation service only when cloud translation is selected in Settings.",
    "实时 OCR": "Live OCR",
    "显示原文": "Show source",
    "显示译文": "Show translation",
    "重选区域": "Reselect area",
    "框选屏幕区域": "Select a screen region",
    "拖动选择 OCR 区域  ·  Esc / 右键取消":
        "Drag to select an OCR area  ·  Esc / right-click to cancel",
    "上一张截图仍在处理中": "The previous screenshot is still being processed",
    "拖动选择区域，Esc 取消": "Drag to select an area; press Esc to cancel",
    "OCR 正在处理中，请稍候": "OCR is processing; please wait",
    "拖动选择要持续翻译的区域，Esc 取消":
        "Drag to select the continuously translated area; press Esc to cancel",
    "已取消框选": "Selection cancelled",
    "正在识别并翻译…": "Recognizing and translating...",
    "正在识别所选区域…": "Recognizing the selected area...",
    "正在识别…": "Recognizing...",
    "识别翻译中…": "Recognizing and translating...",
    "画面稳定": "Image unchanged",
    "未检测到文字，等待下一帧": "No text detected; waiting for the next frame",
    "没有检测到文字，请放大区域或提高对比度":
        "No text detected. Select a larger area or improve the contrast.",
    "OCR 已暂停，请修复模型后重试":
        "OCR paused. Repair or switch the model, then retry.",
    "已暂停，覆盖译文保持显示": "Paused; the translated overlay remains visible",
    "已继续，等待画面变化": "Resumed; waiting for the image to change",
    "实时 OCR 已结束": "Live OCR stopped",
    "OCR 失败": "OCR failed",
    "截图失败": "Screenshot failed",
    "实时截图失败": "Live screenshot failed",
    "OCR 图片缓存": "OCR image cache",
    "上传/截图原图与译后覆盖图分开保存，绝不写入 C 盘。默认每类保留最近 15 张；设为 0 表示无限保留。":
        "Uploaded/captured source images and translated overlays are stored separately and never written to drive C. Each type keeps 15 by default; 0 means unlimited.",
    "无限": "Unlimited",
    " 张/类": " per type",
    "每类保留": "Keep per type",
    "打开缓存": "Open cache",
    ...
    "选择非 C 盘 OCR 图片缓存目录":
        "Choose an OCR image cache folder outside drive C",
    "原图保存在 originals，译后图片保存在 translated。":
        "Source images are stored in originals; translated images are stored in translated.",
    "尚未配置非 C 盘目录": "No non-C drive folder configured",
    "无法打开 OCR 缓存": "Could not open the OCR cache",
    "图片文字识别": "Image OCR",
    "OCR 识别": "OCR",
    "打开浮窗": "Open overlay",
    ...
    "已保存，重载失败；请检查 DSN": "Saved, but reload failed; check the DSN",
    "刷新": "Refresh",
    "导出日志": "Export logs",
    "清空视图": "Clear view",
